...
def sample_hyperparams(trial):
    ...
    sampled_erl_params = {
        ...
        "net_dimension": trial.suggest_categorical("net_dimension", [2 ** 9, 2 ** 10]),
        ...
        "break_step": trial.suggest_categorical("break_step", [3e4, 4.5e4])
    }
...
print('\nStarting CPCV optimization with:', flush=True)
