...
# Add tld='us' to use the Binance.US API endpoint
binance_client = Client(api_key=API_KEY_BINANCE, api_secret=API_SECRET_BINANCE, tld='us')
...
class BinanceProcessor():
    def __init__(self):
        ...
        self.binance_client = Client(api_key=API_KEY_BINANCE, api_secret=API_SECRET_BINANCE, tld = 'us')
